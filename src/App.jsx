  ...
  return (
    <div className={`transition-overlay ${type}`}>
      <div className="transition-content">
        {type === 'to_night'
          ? <><div className="trans-icon">🌙</div><p className="trans-text">Night Falls...</p></>
          : <><div className="trans-icon">☀️</div><p className="trans-text">Dawn Breaks...</p></>
        }
      </div>
    </div>
  )
...
export default function App() {
  ...
  const screens = { home: <HomeScreen />, lobby: <LobbyScreen />, role_reveal: <RoleRevealScreen />, night: <NightScreen />, day: <DayScreen />, ended: <EndedScreen /> }
  return (
    <div className="app">
      {screens[screen] || <HomeScreen />}
      {transitioning && <Transition type={transitionType} />}
    </div>
  )
}
